...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Excessão lançada quando um valor negativo é utilizado no argumento <paramref name="valor"/>.</exception>
        /// <exception cref="SaldoInsuficienteException">Excessão lançada quando o valor de <paramref name="valor"/>  é maior que o valor da propriedade <see cref="Saldo"/>.</exception>
